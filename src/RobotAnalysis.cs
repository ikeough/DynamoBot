...
namespace Dynamo.Analysis
{
    ...
    public class RobotModel
    {
		...
		private Hashtable _barInfo = new Hashtable();
		private Hashtable _nodeInfo = new Hashtable();
		private Hashtable _plateInfo = new Hashtable();
        ...
        public RobotModel(IRobotApplication robot, Hashtable nodeInfo, Hashtable barInfo, Hashtable plateInfo)
		{
			...
			//create load cases
			IRobotSimpleCase dl = _structure.Cases.CreateSimple(_structure.Cases.FreeNumber, "Catia_DL", IRobotCaseNature.I_CN_PERMANENT, IRobotCaseAnalizeType.I_CAT_STATIC_LINEAR);
			IRobotSimpleCase ll = _structure.Cases.CreateSimple(_structure.Cases.FreeNumber, "Catia_LL", IRobotCaseNature.I_CN_EXPLOATATION, IRobotCaseAnalizeType.I_CAT_STATIC_LINEAR);
			IRobotSimpleCase wl = _structure.Cases.CreateSimple(_structure.Cases.FreeNumber, "Catia_WL", IRobotCaseNature.I_CN_WIND, IRobotCaseAnalizeType.I_CAT_STATIC_LINEAR);
			IRobotSimpleCase bl = _structure.Cases.CreateSimple(_structure.Cases.FreeNumber, "Catia_BL", IRobotCaseNature.I_CN_EXPLOATATION, IRobotCaseAnalizeType.I_CAT_STATIC_LINEAR);
...
//			IRobotSimpleCase wl_uplift = _structure.Cases.CreateSimple(_structure.Cases.FreeNumber, "Catia_WL_Uplift", IRobotCaseNature.I_CN_WIND, IRobotCaseAnalizeType.I_CAT_STATIC_LINEAR);
			IRobotCaseCombination comb1 = _structure.Cases.CreateCombination(_structure.Cases.FreeNumber, "Catia_DL+LL+WL+BL", IRobotCombinationType.I_CBT_ACC, IRobotCaseNature.I_CN_PERMANENT, IRobotCaseAnalizeType.I_CAT_COMB);
			IRobotCaseCombination comb2 = _structure.Cases.CreateCombination(_structure.Cases.FreeNumber, "Catia_DL_60+WL", IRobotCombinationType.I_CBT_ACC, IRobotCaseNature.I_CN_PERMANENT, IRobotCaseAnalizeType.I_CAT_COMB);
...
//				double sectionthickness	= _barInfo[0].SectionThickness/1000;	//the thickness in meters
				...
				nonst_data1.SetValue(IRobotBarSectionNonstdDataValue.I_BSNDV_TUBE_D, _sectionInfo[0]/1000);	//the section diameter
				nonst_data1.SetValue(IRobotBarSectionNonstdDataValue.I_BSNDV_TUBE_T, _sectionInfo[1]/1000);	//the section thickness
				data1.CalcNonstdGeometry();
				_structure.Labels.Store(sec1);
				
				nonst_data2.SetValue(IRobotBarSectionNonstdDataValue.I_BSNDV_TUBE_D, _sectionInfo[2]/1000);	//the section diameter
				nonst_data2.SetValue(IRobotBarSectionNonstdDataValue.I_BSNDV_TUBE_T, _sectionInfo[3]/1000);	//the section thickness
				data2.CalcNonstdGeometry();
				_structure.Labels.Store(sec2);
				
				nonst_data3.SetValue(IRobotBarSectionNonstdDataValue.I_BSNDV_TUBE_D, _sectionInfo[4]/1000);	//the section diameter
				nonst_data3.SetValue(IRobotBarSectionNonstdDataValue.I_BSNDV_TUBE_T, _sectionInfo[5]/1000);	//the section thickness
				...
				nonst_data4.SetValue(IRobotBarSectionNonstdDataValue.I_BSNDV_RECT_B, 2*_sectionInfo[7]/1000);	//generate correct section properties without overlapping thicknesses
				...
				nonst_data5.SetValue(IRobotBarSectionNonstdDataValue.I_BSNDV_RECT_B, 2*_sectionInfo[9]/1000);	//generate correct section properties without overlapping thicknesses
				...
				nonst_data6.SetValue(IRobotBarSectionNonstdDataValue.I_BSNDV_RECT_B, 2*_sectionInfo[11]/1000);	//generate correct section properties without overlapping thicknesses
			...
			for (int i=0; i<_barInfo.Count; i++)
			{
				...
				//create the bar
				_bars.Create(barId, robStart, robEnd);
...
//			thickness.MaterialName = materialName;
			...
			for (int i=0; i<_plateInfo.Count; i++)
			{
				...
				var p = (Analytical)_plateInfo[i];	//the plate to create
